...
# # ---------- Load the image ----------
# image_path = "binaryimage.png"

# image = cv2.imread(image_path, cv2.IMREAD_GRAYSCALE)

# if image is None:
#     raise FileNotFoundError("Image not found. Check the image name.")
...
# # ---------- Display Results ----------
# cv2.imshow("CS24106 Original Binary", binary)
# cv2.imshow("CS24106 Erosion", erosion)
# cv2.imshow("CS24106 Dilation", dilation)
# cv2.imshow("CS24106 Opening", opening)
# cv2.imshow("CS24106 Closing", closing)
# cv2.waitKey(0)
...
#     cv2.imshow(f"{op_name} with Contours", contoured_img)
